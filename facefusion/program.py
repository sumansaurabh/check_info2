...
def create_program() -> ArgumentParser:
	...
	# api
	sub_program.add_parser('api', help = 'run the REST API server', parents = [ create_config_path_program(), create_temp_path_program(), create_jobs_path_program(), create_log_level_program() ], formatter_class = create_help_formatter_large)
	# job manager
